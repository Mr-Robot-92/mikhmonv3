# mikhmon-expire-monitor-v7.11.2--v7xxxx
Si vous utilisez un RouteurOs V7.11.2 ou supérieure : copier cet script ensuit collé dans votre schedule(dans winbox)
```
:local dateint do={
